...
setup(
    name='AivenExercise',
    description="Checks website, write to kafka, store in DB",
    ...
    author_email='mick.lausch@gmail.com',
    # Use the URL to the github repo.
    url= 'https://github.com/mlausch1963/ae',
    download_url=(
        f'https://github.com/mlausch1963/'
        f'ae/archive/{version}.tar.gz'
    ),
    keywords=[
